...
from .views import GameListView, GameDetailView, GameUpdateView, GameDeleteView, GameListingCreateView, GameListingDetailView
...
urlpatterns = [
    ...
    url(r'^(?P<pk>\d+)/(?P<id>\d+)/$', GameListingDetailView.as_view(), name='listing')
